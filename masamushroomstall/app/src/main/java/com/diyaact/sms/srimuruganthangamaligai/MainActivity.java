package com.diyaact.sms.srimuruganthangamaligai;
...
public class MainActivity extends AppCompatActivity {
    ...
    WebView webView;
    private String webUrl = "https://srimuruganthangamaligai.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //checkout.setKeyID("rzp_live_RzDrjR8jZ6TVdH");
...
getSupportActionBar().hide();
        ...
        webView.addJavascriptInterface("PaymentInterface", String.valueOf(new PaymentInterface()));
